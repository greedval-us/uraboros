<div class="report-section">
    ...
    <div class="metrics-box">
        <div style="font-weight: 700; color: #1f2937; margin-bottom: 12px;">Summary for the period</div>
...
<div class="report-section page-break">
    ...
    <p style="margin-top: 15px; padding: 12px; background-color: #f0f9ff; border-left: 4px solid #0ea5e9; border-radius: 0;">
        💡 <strong>Note:</strong> Daily metric values are presented at the end of the report in Table 1.4.
    </p>
</div>

<div class="report-section page-break">
    <div class="report-section-title">📊 Table 1.1 - User Activity</div>
...
@if(!empty($postsByDay))
    <div class="report-section page-break">
        <div class="report-section-title">📊 Table 1.2 - Posting Frequency</div>
        <table class="report-table">
            <thead>
                <tr>
                    <th>Day</th>
...
@if(!empty($engagementByDay))
    <div class="report-section page-break">
        <div class="report-section-title">📊 Table 1.3 - Average Engagement</div>
        <table class="report-table">
            <thead>
                <tr>
                    <th>Day</th>
...
@if(!empty($participantChanged))
    <div class="report-section page-break">
        <div class="report-section-title">📊 Table 1.4 - Audience Changes</div>
        <table class="report-table">
            <thead>
                <tr>
                    <th>Day</th>
