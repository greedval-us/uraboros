<div class="report-section page-break">
    ...
    <div class="report-section page-break">
        @if(!empty($funnelByDay))
            <div class="">Table 2: Engagement Funnel</div>
        ...
        @if(!empty($viewRatePeriod))
            <div class="report-section-title">Table 2.1 Content Views</div>
            <table class="report-table">
                <thead>
                    <tr>
                        <th>Post ID</th>
        ...
        @if(!empty($reactionRatePeriod))
            <div class="report-section-title">Table 2.2 Reactions</div>
            <table class="report-table">
                <thead>
                    <tr>
                        <th>Post ID</th>
        ...
        @if(!empty($commentRatePeriod))
            <div class="report-section-title">Table 2.3 Comments</div>
            <table class="report-table">
                <thead>
                    <tr>
                        <th>Post ID</th>
        ...
        @if(!empty($ERviewPeriod))
            <div class="report-section-title">Table 2.4 View-Based Engagement</div>
            <table class="report-table">
                <thead>
                    <tr>
                        <th>Post ID</th>
