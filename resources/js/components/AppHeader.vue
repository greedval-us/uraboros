...
const activeItemStyles = computed(
    () => (url: NonNullable<InertiaLinkProps["href"]>) =>
        isCurrentRoute.value(toUrl(url)) ? "bg-primary/15 text-foreground" : ""
);
...
<template>
    <div>
        <div class="glass-panel border-b border-border/70">
        ...
        <div
            ...
            class="glass-panel flex w-full border-b border-border/70"
        >
            <div
