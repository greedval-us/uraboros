...
class AudienceQualityJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        $this->botServices->delete($this->chat, $this->messageID);
        $this->botServices->sendInline(CommandKey::AudienceQualityA->value, $this->lang, $this->chat, $replace, ['group' => $this->text]);
    }
}
