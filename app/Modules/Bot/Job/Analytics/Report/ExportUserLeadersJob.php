...
class ExportUserLeadersJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        try {
            ...
            $analytic = $this->apiServices->get('analytics/getActivityLeaders', ['from' => $from->toIso8601String(), 'to' => $to->toIso8601String(), 'id_group' => $this->query]);
        } catch (\Throwable $e) {
        ...
        $pdf = $this->pdfReportServices->generate($context, ReportType::USERLEADERS);
